                ...
                <div className="flex flex-wrap -mx-4">
                    ...
                    <div className="w-full md:w-1/2 px-4">
                        ...
                        <p className="text-gray-700 mb-6">
                            Experience premium sound quality and industry-leading noise cancellation with these wireless headphones. Perfect
                            for music lovers and frequent travelers.
                        </p>
                        <div className="mb-6">
                            <h3 className="text-lg font-semibold mb-2">Color:</h3>
                            <div className="flex space-x-2">
                                {["black", "gray-300", "blue-500"].map((color, i) => (
                                    <button
                                        key={i}
