...
export default function Authorize() {
    ...
    const fetchData = async () => {
        try {
            const request = await fetch("http://localhost:2500/login")
    ...
    useEffect(() => {
        console.log("User data after fetch:", JSON.stringify(user));
    }, [user]);
                    ...
                    login ? (
                        <div className="sm:max-w-md relative flex flex-col p-4 rounded-md text-black bg-white border-2 sm:border-0 sm:w-[25vw] shadow-lg">
                            ...
                            <form className="flex flex-col gap-3" method="post" onSubmit={handleSubmit}>
                                ...
                                <button
                                    type="submit"
                                    className="bg-[#7747ff] w-max px-6 py-2 rounded text-white text-sm font-normal"
                                >
                                    Submit
                                </button>
                            </form>
                            <div className="text-sm text-center mt-[1.6rem]">
                                ...
                                <a className="text-sm text-[#7747ff]" href="#" onClick={() => setLogin(!login)}>
                                    Sign up for free!
                                </a>
                            </div>
                        </div>
