export default function CardSm({ title, image, price, items }) {
    return (
        <div className=" screen-425:w-fit screen-425:px-8 sm:px-4 gap-8 mx-auto sm:w-[280px] lg:w-[290px] shadow-lg h-[120px] p-4 flex sm:gap-4 justify-center sm:justify-between items-center transition-all my-4 cursor-pointer hover:scale-[1.05]">
            <div className="">
