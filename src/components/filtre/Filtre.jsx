                                    ...
                                    <div className="border-b border-gray-200 py-6">
                                        ...
                                        <div className="pt-6" id="filter-section-0">
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex items-center">
                                                    <input id="filter-color-2" name="color[]" value="blue" type="checkbox" defaultChecked className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500" />
                                    ...
                                    <div className="border-b border-gray-200 py-6">
                                        ...
                                        <div className="pt-6" id="filter-section-1">
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex items-center">
                                                    <input id="filter-category-2" name="category[]" value="travel" type="checkbox" defaultChecked className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500" />
                                    ...
                                    <div className="border-b border-gray-200 py-6">
                                        ...
                                        <div className="pt-6" id="filter-section-2">
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex items-center">
                                                    <input id="filter-size-5" name="size[]" value="40l" type="checkbox" defaultChecked className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500" />
