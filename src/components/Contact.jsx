export default function Contact() {
    return (
        <div className=" mx-auto p-5">
            <div className="">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1766.6529347939647!2d85.34028109839481!3d27.6769398!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb1900173e0fc9%3A0x3ac9cf8ea647eaf3!2sSubhakamana%20gate!5e0!3m2!1sen!2snp!4v1727016066639!5m2!1sen!2snp" width="" style={{ width: "100%" }} height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <div className="max-w-5xl mx-auto mb-10">
                <div className="text-center py-10 ">
                    <h2 className="font-bold text-4xl text-[--primary]">Contact Us</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 border border-slate-400 ">
                    <div className=" md:col-span-4 p-10 text-white  border-r-2 bg-[--primary]">
